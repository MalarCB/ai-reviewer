...
import { File, FileDiff, formatFileDiff, generateFileCodeDiff } from "./diff";
...
-old code line2 removed in the PR
 ...
 codereviewai: This is a comment on the code
 user2: This is a reply to the comment above
 __existing_comment_thread__
 codereviewai: This is a comment on some other parts of the code
